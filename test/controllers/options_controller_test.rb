...
class OptionsControllerTest < ActionController::TestCase
  ...
  test "should create option" do
    assert_difference('Option.count') do
      post :create, option: { select_counts: @option.select_counts, subject: @option.subject, thumb: @option.thumb, title: @option.title }
    end
  ...
  test "should update option" do
    patch :update, id: @option, option: { select_counts: @option.select_counts, subject: @option.subject, thumb: @option.thumb, title: @option.title }
    assert_redirected_to option_path(assigns(:option))
  end
